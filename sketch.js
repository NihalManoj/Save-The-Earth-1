//create the objects-PLAYER, give it behaviours(move up, left & right with arrow keys; moves only upwards).
//make it an infinite game world(moving vertically up).
//create trash at intervals(generates at random x positions).
//create the scoring system.
//behaviours when trash hits the player.
//when 100 trash is picked, the player wins. If 100 trash is not picked until a certain distance the player loses
//GAMESTATES.
